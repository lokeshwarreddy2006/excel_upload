		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mass Upload",
									"targetURL": "#compimdexcelupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compimdexcelupload-display": {
								"semanticObject": "compimdexcelupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pimd.excelupload",
									"url": sap.ui.require.toUrl("com/pimd/excelupload")
								}
							}
						}
					}
